    ...
    return (
        <View style={{ flex: 1, backgroundColor: 'white' }} >
            <View style={{ height: "30%", backgroundColor: "#232b40", justifyContent: 'space-evenly', alignItems: 'center' }}>
                <View style={{ width: width * 0.23, height: width * 0.23, backgroundColor: "white", borderRadius: (width * 0.27) / 2 }}></View>
                <View>
                    <Text style={{ fontSize: width * 0.056, color: 'white', fontWeight: 'bold', alignSelf: "center" }} >Ankan Roy</Text>
                    <Text style={{ fontSize: width * 0.048, color: 'white', fontWeight: 'bold', alignSelf: "center" }} >ankanRoy@email.com</Text>
                </View>
            </View>
            <View style={{ flex: 1 }}>
                <ScrollView>
